...
class DataDownloader {
    ...
    func loadSingleStock(symbol: String) {
        print("lefutott")
        let urlString = "https://api.polygon.io/v2/aggs/ticker/\(symbol.uppercased())/range/1/day/2022-09-21/2022-09-28?adjusted=true&sort=asc&limit=120&apiKey=EYcBp6VoRXW0iyk_ch7sy3NgpEbAfXqs"
