...
struct CommunitiesListItem_Previews: PreviewProvider {
    static var previews: some View {
        CommunitiesListItem(community: MessageGroup(id: "1", name: "Bitcoin Community", messages:[Message(id: "123", sender: "Dominik", senderemail: "mail", message: "Első üzenet", time: "2022-02-02"),Message(id: "124", sender: "Dominik",senderemail: "mail", message: "Második üzenetMásodik üzenetMásodik üzenetMásodik üzenetMásodik üzenetMásodik üzenetMásodik üzenetMásodik üzenet", time:"2022-02-02"),Message(id: "125", sender: "Dominik", senderemail: "email", message: "Harmadik üzenet", time: "2022-02-02")], members: ["szia"], lastid: "jasd"))
    }
}
